...
export default defineComponent({
  ...
  setup() {
    ...
    const handleQuery = (params: any) => {
      ...
      axios.get("/out-application/todo", {
        params: {
          page: params.page,
          size: params.size,
    ...
    const processApp = (record: any, applicationState: any) => {
      ...
      const req = ref();
      req.value = {};
      req.value.applicationState = applicationState;
      req.value.applicationId = record.applicationId;

      axios.post("/out-application/save", current_user,{
        headers:{
          'type': store.getters.getUser().type,
        }
      }).then((response) => {
