  ...
  <a-layout>
    ...
    <a-layout-content
      ...
      >
        ...
        <template v-slot:lastCovidDate="{text, record}">
          <a-tag color="#f50">{{record.lastCovidDate}}</a-tag>
        </template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const columns = [
      ...
      {
        title: '上次核酸检测日期',
        slots: {customRender: 'lastCovidDate'},
        align: 'center'
      },
      {
        title: '上报日期',
